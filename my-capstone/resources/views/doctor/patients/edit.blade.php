    ...
    <x-slot name="breadcrumbs">
        ...
        <li aria-current="page">
            <div class="flex items-center">
                ...
                <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">Edit Patient</span>
            </div>
        </li>
    </x-slot>
    ...
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-sm text-gray-600 mt-0.5">Update patient information for {{ $patient->first_name }} {{ $patient->last_name }}</p>
            </div>
        </div>
    </x-slot>
                ...
                <div class="p-6" x-data="{ activeTab: 'personal' }">
                    ...
                    <div class="mb-6 p-6 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-indigo-50">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="date_of_birth" class="block mt-1 w-full flatpickr" type="text" name="date_of_birth" :value="old('date_of_birth', $patient->date_of_birth)" required autocomplete="bday" />
                    ...
                    <x-modal name="patient-details-modal" :show="$showModalEdit" focusable maxWidth="2xl" x-cloak
                        x-data="{ show: $showModalEdit }" x-on:open-additional-patient-details-modal.window="show = true">
                        <!-- Modal Header -->
